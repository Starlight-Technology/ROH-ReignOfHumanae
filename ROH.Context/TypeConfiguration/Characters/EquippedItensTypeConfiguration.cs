...
namespace ROH.Context.TypeConfiguration.Characters
{
    public class EquippedItensTypeConfiguration : IEntityTypeConfiguration<EquippedItens>
    {
        public void Configure(EntityTypeBuilder<EquippedItens> builder)
        {
            ...
            _ = builder.HasOne(e => e.Character).WithOne(c => c.EquippedItens).HasForeignKey<EquippedItens>(e => e.IdCharacter);
            ...
            _ = builder.HasMany(e => e.LeftHandRings).WithOne(l => l.EquippedItens).HasForeignKey(l => l.IdEquippedItens);
            _ = builder.Ignore(e => e.LeftHandRings);
            _ = builder.HasMany(e => e.RightHandRings).WithOne(l => l.EquippedItens).HasForeignKey(l => l.IdEquippedItens);
        }
    }
}
