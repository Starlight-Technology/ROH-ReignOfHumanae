//-----------------------------------------------------------------------
// <copyright file="GameVersionRepositoryTest.cs" company="Starlight-Technology">
//     Author:  
...
public class GameVersionRepositoryTests
{
    ...
    public async Task GetAllReleasedVersionsAsync_ReturnsCorrectData()
    {
        ...
        // Act
        Context.Version.Paginator.Paginated result = await repository.GetAllReleasedVersionsAsync();
    ...
    public async Task GetAllVersionsAsync_ReturnsCorrectData()
    {
        ...
        // Act
        Context.Version.Paginator.Paginated result = await repository.GetAllVersionsAsync();
        List<GameVersion>? versions = [.. result.ObjectResponse.Cast<GameVersion>()];
    ...
    public async Task GetCurrentGameVersionAsync_ReturnsLatestReleasedVersion()
    {
        ...
        // Act
        GameVersion? result = await repository.GetCurrentGameVersionAsync();
    ...
    public async Task GetVersionByGuidAsync_ReturnsCorrectVersion()
    {
        ...
        context.GameVersions
            .Add(new(new DateTime(2023, 1, 1, 0, 0, 0, DateTimeKind.Utc), 1, guid, 1, 0, 5) { Released = true });
        await context.SaveChangesAsync();

        // Act
        GameVersion? result = await repository.GetVersionByGuidAsync(guid);
    ...
    public async Task SetNewGameVersionAsync_AddsVersionCorrectly()
    {
        ...
        // Act
        GameVersion result = await repository.SetNewGameVersionAsync(version);
    ...
    public async Task UpdateGameVersionAsync_UpdatesVersionCorrectly()
    {
        ...
        GameVersion result = await repository.UpdateGameVersionAsync(version);
    ...
    public async Task VerifyIfExistAsync_ReturnsTrueIfExists()
    {
        ...
        // Act
        bool result = await repository.VerifyIfExistAsync(version);
    ...
    public async Task VerifyIfExistAsyncWithGuid_ReturnsTrueIfExists()
    {
        ...
        // Act
        bool result = await repository.VerifyIfExistAsync(guid);
